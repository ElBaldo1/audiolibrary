...
/**
 * classe rappresentante la specializzazione per ottenere la lista degli audiolibri nella home page
 */
public class ListaAudiolibriHome implements ListaAudiolibri {
    @Override
    public List<Audiolibro> getListaAudiolibri(Utente utente, AudiolibroRepo audiolibroRepo) {
        return utente.getAudiolibroCreati();
    }
}
